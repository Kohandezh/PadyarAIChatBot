...
@pytest.mark.parametrize("value", [
    "sk-proj-7Kq2mVx9Lp4RtZw8Nb3Yc6Hd1Fg5Js0Aa",
    "sk-ant-api03-9Fk2Lm4Pq7Rt1Vw6Yz3Bc8Nd5Hg0Js",
    "xai-9Fk2Lm4Pq7Rt1Vw6Yz3Bc8Nd5Hg0Js",
    "gsk_9Fk2Lm4Pq7Rt1Vw6Yz3Bc8Nd5Hg0Js",
    "AIzaSy9Fk2Lm4Pq7Rt1Vw6Yz3Bc8Nd5Hg0Js4Xp",
    "gw_live_9Fk2Lm4Pq7Rt1Vw6Yz",
])
def test_a_realistic_key_is_rejected(scan, value):
    ...
    assert scan.PATTERNS.search(value), f"no shape matched {value[:8]}…"
    packager = scan._load_packager()
    assert not packager._is_placeholder(value), f"{value[:8]}… judged fake"
...
def test_a_planted_key_in_a_test_file_is_caught(scan, tmp_path, monkeypatch):
    ...
    planted.write_text('K = "sk-proj-7Kq2mVx9Lp4RtZw8Nb3Yc6Hd1Fg5Js0Aa"\n',
                       encoding="utf-8")
    try:
...
def test_the_scanner_never_prints_the_value_it_found(scan, monkeypatch):
    ...
    secret = "sk-proj-7Kq2mVx9Lp4RtZw8Nb3Yc6Hd1Fg5Js0Aa"
